...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	МесяцНачисления = НачалоМесяца(ЭтотОбъект.ДатаНачисления);
	...
	Пока МесяцНачисления <= МесяцОкончания Цикл
		...
		Движение.ПериодДействияНачало   = Макс(ЭтотОбъект.ДатаНачисления, МесяцНачисления);
		...
		Движение.БазовыйПериодНачало    = Макс(ЭтотОбъект.ДатаНачисления, МесяцНачисления);
